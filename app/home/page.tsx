...
>CG Splitter
      ...
      <div className="flex items-center gap-5 text-sm font-medium pr-20">
        ...
        <span className="bg-white text-black px-4 py-2 rounded-full font-semibold hover:bg-green-500 transition">Login</span>
        <span className="bg-white text-black px-4 py-2 rounded-full font-semibold hover:bg-green-500 transition">Sign Up</span>
...
<div className="px-10 mt-10">
  <h1 className="font-bold text-black text-5xl"> Namaste Abhijeet</h1>
